...
files = os.listdir('Tokyo')
os.chdir("./Tokyo")

def main():
    
    mizumashi(files,5,5,3,3,5,5,3,3)

'''
    mizumashi(files,a,b,c,d,e,f,g,h)


各パラメータ

files = 指定ディレクトリ内にある画像が入る
...
def mizumashi(list,a,b,c,d,e,f,g,h):
    ...
    for n in range(0,len(list)):
        ...
        for m in range(1,a+1):
            ...
            # 結果を出力
            cv2.imwrite("{0}_{1}.jpg".format(dst,m), gamma1_img)
        ...
        for m in range(1,b+1):
            ...
            # 結果を出力
            cv2.imwrite("{0}_{1}.jpg".format(dst,a+m), gamma2_img)
        ...
        for m in range(1,c+1):
            for n in range(1,d+1):
                ...
                # 結果を出力
                cv2.imwrite("{0}_{1}.jpg".format(dst,a+b+c*(m-1)+n), blur_img)
        ...
        for m in range(1,e+1):
            ...
            # 結果を出力
            cv2.imwrite("{0}_{1}.jpg".format(dst,a+b+c*d+m), dst1)
